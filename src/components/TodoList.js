...
const TodoList = ({
  ...
  const textPlacer = filterStatus === "completed" ? "tareas completadas" : "tareas";
    ...
    <>
      <section className="todo-list-section">
        {filteredTodos.length < 1 ? (
          <p className="info-text">No hay {textPlacer}</p>
        ) : (
        ...
        <div className="todo-filter-control">
          <div className="todos-count">{leftTodoCount} pendientes</div>
